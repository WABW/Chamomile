...
public final class Utility {
     ...
     */
    public static 
    io.wabw.misc.mail.imap.protocol.MessageSet[] toMessageSet(Message[] msgs, Condition cond) {
	...
	for (int i = 0; i < msgs.length; i++) {
	    ...
	    io.wabw.misc.mail.imap.protocol.MessageSet set = new io.wabw.misc.mail.imap.protocol.MessageSet();
	    set.start = current;
	...
	if (v.isEmpty()) // No valid messages
	    ...
	    io.wabw.misc.mail.imap.protocol.MessageSet[] sets = new io.wabw.misc.mail.imap.protocol.MessageSet[v.size()];
	    v.copyInto(sets);
	    return sets;
	}
    }
     ...
     */
    public static io.wabw.misc.mail.imap.protocol.UIDSet[] toUIDSet(Message[] msgs) {
	Vector v = new Vector(1);
	long current, next;
	...
	for (int i = 0; i < msgs.length; i++) {
	    ...
	    io.wabw.misc.mail.imap.protocol.UIDSet set = new io.wabw.misc.mail.imap.protocol.UIDSet();
	    set.start = current;
	...
	if (v.isEmpty()) // No valid messages
	    ...
	    io.wabw.misc.mail.imap.protocol.UIDSet[] sets = new io.wabw.misc.mail.imap.protocol.UIDSet[v.size()];
	    v.copyInto(sets);
	    return sets;
	}
    }
