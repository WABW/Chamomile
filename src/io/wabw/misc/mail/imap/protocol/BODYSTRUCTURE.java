...
public class BODYSTRUCTURE implements Item {
    ...
    public BODYSTRUCTURE(FetchResponse r) throws io.wabw.misc.mail.iap.ParsingException {
	if (parseDebug)
    ...
    private ParameterList parseParameters(io.wabw.misc.mail.iap.Response r)
	...
	if (b == '(') {
	    ...
	    throw new io.wabw.misc.mail.iap.ParsingException("Parameter list parse error");

	return list;
    }

    private void parseBodyExtension(io.wabw.misc.mail.iap.Response r) throws io.wabw.misc.mail.iap.ParsingException {
	r.skipSpaces();
