...
public class SearchSequence {
     ...
     */
    public static io.wabw.misc.mail.iap.Argument generateSequence(SearchTerm term, String charset)
    ...
    private static io.wabw.misc.mail.iap.Argument and(AndTerm term, String charset)
			throws SearchException, IOException {
	// Combine the sequences for both terms
	SearchTerm[] terms = term.getTerms();
	// Generate the search sequence for the first term
	io.wabw.misc.mail.iap.Argument result = generateSequence(terms[0], charset);
	// Append other terms
    ...
    private static io.wabw.misc.mail.iap.Argument or(OrTerm term, String charset)
			throws SearchException, IOException {
	SearchTerm[] terms = term.getTerms();
	...
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument not(NotTerm term, String charset)
			throws SearchException, IOException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument header(HeaderTerm term, String charset)
			throws SearchException, IOException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument messageid(MessageIDTerm term, String charset)
			throws SearchException, IOException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
	result.writeAtom("HEADER");
    ...
    private static io.wabw.misc.mail.iap.Argument flag(FlagTerm term) throws SearchException {
    ...
    private static io.wabw.misc.mail.iap.Argument from(String address, String charset)
			throws SearchException, IOException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument recipient(Message.RecipientType type,
    ...
    private static io.wabw.misc.mail.iap.Argument subject(SubjectTerm term, String charset)
			throws SearchException, IOException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument body(BodyTerm term, String charset)
			throws SearchException, IOException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument size(SizeTerm term)
    ...
    private static io.wabw.misc.mail.iap.Argument sentdate(DateTerm term)
			throws SearchException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
    ...
    private static io.wabw.misc.mail.iap.Argument receiveddate(DateTerm term)
			throws SearchException {
	io.wabw.misc.mail.iap.Argument result = new io.wabw.misc.mail.iap.Argument();
	String date = toIMAPDate(term.getDate());
