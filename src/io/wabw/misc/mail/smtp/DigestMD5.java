...
public class DigestMD5 {
	...
	md5.update(md5.digest(
		io.wabw.misc.mail.util.ASCIIUtility.getBytes(user + ":" + realm + ":" + passwd)));
	md5.update(io.wabw.misc.mail.util.ASCIIUtility.getBytes(":" + nonce + ":" + cnonce));
	clientResponse = toHex(md5.digest())
		+ ":" + nonce  + ":" + nc + ":" + cnonce + ":" + qop + ":";
	
	// DIGEST-MD5 computation, client response (order critical)
	md5.update(io.wabw.misc.mail.util.ASCIIUtility.getBytes("AUTHENTICATE:" + uri));
	md5.update(io.wabw.misc.mail.util.ASCIIUtility.getBytes(clientResponse + toHex(md5.digest())));
	...
	if (debugout != null)
	    debugout.println("DEBUG DIGEST-MD5: Response => "
			 + result.toString());
	b64os.write(io.wabw.misc.mail.util.ASCIIUtility.getBytes(result.toString()));
	b64os.flush();
	...
	md5.update(io.wabw.misc.mail.util.ASCIIUtility.getBytes(":" + uri));
	md5.update(io.wabw.misc.mail.util.ASCIIUtility.getBytes(clientResponse + toHex(md5.digest())));
	...
	StreamTokenizer	tokens
		= new StreamTokenizer(
		    new InputStreamReader(
		      new io.wabw.misc.mail.util.BASE64DecoderStream(
