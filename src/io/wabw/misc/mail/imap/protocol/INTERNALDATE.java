...
public class INTERNALDATE implements Item {
     ...
     * Constructor
     */
    public INTERNALDATE(FetchResponse r) throws io.wabw.misc.mail.iap.ParsingException {
	msgno = r.getNumber();
	r.skipSpaces();
	String s = r.readString();
	if (s == null)
	    throw new io.wabw.misc.mail.iap.ParsingException("INTERNALDATE is NIL");
	try {
	    date = mailDateFormat.parse(s);
	} catch (ParseException pex) {
	    throw new io.wabw.misc.mail.iap.ParsingException("INTERNALDATE parse error");
	}
    }
