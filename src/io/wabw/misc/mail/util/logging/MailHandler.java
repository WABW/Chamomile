...
package io.wabw.misc.mail.util.logging;
 ...
 *      MailHandler.mail.smtp.host = my-mail-server
 *      MailHandler.mail.to = me@example.com
 *      MailHandler.level = WARNING
 *      MailHandler.verify = local
 * </pre></tt>
 *
 ...
 *
 * <ul>
 * <li>MailHandler.attachment.filters a comma
 ...
 *
 * <!--
 * <li>MailHandler.comparator.reverse a boolean
 ...
 * -->
 * 
 * <li>MailHandler.encoding the name of the Java
 ...
 * platform encoding).
 *
 * <li>MailHandler.errorManager name of an
 ...
 * 
 * <li>MailHandler.mail.cc a comma separated list of
 ...
 *
 * <li>MailHandler.mail.from a comma separated list of
 ...
 *
 * <li>MailHandler.mail.host the host name or IP
 ...
 *
 * <li>MailHandler.mail.reply.to a comma separated
 ...
 * (defaults to <tt>null</tt>, none)
 *
 * <li>MailHandler.mail.to a comma separated list of
 ...
 *
 * <li>MailHandler.mail.sender a single address
 ...
 *
 * <li>MailHandler.verify <a name="verify">used</a> to
            ...
            if ("remote".equals(verify)) {
                ...
                try {
                    try {
                        ...
                        if (t instanceof io.wabw.misc.mail.smtp.SMTPTransport) {
                            host = ((io.wabw.misc.mail.smtp.SMTPTransport) t).getLocalHost();
                        }
