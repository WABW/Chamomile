...
public class Namespaces {
	 ...
	 */
	public Namespace(io.wabw.misc.mail.iap.Response r) throws io.wabw.misc.mail.iap.ProtocolException {
		...
		String s = r.readAtom();
		if (s == null)
		    throw new io.wabw.misc.mail.iap.ProtocolException("Expected NIL, got null");
		if (!s.equalsIgnoreCase("NIL"))
		    throw new io.wabw.misc.mail.iap.ProtocolException("Expected NIL, got " + s);
		delimiter = 0;
	    }
	    ...
	    if (r.readByte() != ')')
		throw new io.wabw.misc.mail.iap.ProtocolException("Missing ')' at end of Namespace");
	}
    };
     ...
     */
    public Namespaces(io.wabw.misc.mail.iap.Response r) throws io.wabw.misc.mail.iap.ProtocolException {
     ...
     */
    private Namespace[] getNamespaces(io.wabw.misc.mail.iap.Response r) throws io.wabw.misc.mail.iap.ProtocolException {
	r.skipSpaces();
