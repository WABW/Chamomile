...
package io.wabw.misc.mail.util;
...
public class SocketFetcher {
	...
	if (useSSL && !(socket instanceof SSLSocket)) {
		...
		try {
		    io.wabw.misc.mail.util.MailSSLSocketFactory msf = new io.wabw.misc.mail.util.MailSSLSocketFactory();
		    if (trusted.equals("*"))
	...
	if (sf instanceof io.wabw.misc.mail.util.MailSSLSocketFactory) {
	    io.wabw.misc.mail.util.MailSSLSocketFactory msf = (io.wabw.misc.mail.util.MailSSLSocketFactory)sf;
