...
package io.wabw.misc.mail.auth;
...
import io.wabw.misc.mail.util.BASE64DecoderStream;
...
public class Ntlm {
	...
	if (debugout != null)
        ...
        String result = null;
	try {
	    result = new String(io.wabw.misc.mail.util.BASE64EncoderStream.encode(msg), "iso-8859-1");
        } catch (UnsupportedEncodingException e) {
            assert false;
        }
        return result;
