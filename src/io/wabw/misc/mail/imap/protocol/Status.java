...
public class Status { 
    ...
    public Status(io.wabw.misc.mail.iap.Response r) throws io.wabw.misc.mail.iap.ParsingException {
	...
	if (r.readByte() != '(')
	    throw new io.wabw.misc.mail.iap.ParsingException("parse error in STATUS");
