...
public class ENVELOPE implements Item {
    ...
    public ENVELOPE(FetchResponse r) throws io.wabw.misc.mail.iap.ParsingException {
	msgno = r.getNumber();

	r.skipSpaces();

	if (r.readByte() != '(')
	    throw new io.wabw.misc.mail.iap.ParsingException("ENVELOPE parse error");
    ...
    private InternetAddress[] parseAddressList(io.wabw.misc.mail.iap.Response r)
		throws io.wabw.misc.mail.iap.ParsingException {
	...
	if (b == '(') {
	    ...
	    throw new io.wabw.misc.mail.iap.ParsingException("ADDRESS parse error");
    }
}
...
class IMAPAddress extends InternetAddress {
    ...
    IMAPAddress(io.wabw.misc.mail.iap.Response r) throws io.wabw.misc.mail.iap.ParsingException {
        r.skipSpaces(); // skip leading spaces
