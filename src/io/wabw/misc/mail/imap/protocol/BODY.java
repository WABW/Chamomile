...
public class BODY implements Item {
    ...
    public int msgno;
    public io.wabw.misc.mail.iap.ByteArray data;
     ...
     * Constructor
     */
    public BODY(io.wabw.misc.mail.imap.protocol.FetchResponse r) throws io.wabw.misc.mail.iap.ParsingException {
	msgno = r.getNumber();
    ...
    public io.wabw.misc.mail.iap.ByteArray getByteArray() {
	return data;
    }
