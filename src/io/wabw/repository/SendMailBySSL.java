...
public class SendMailBySSL {
    ...
    public static void SSS(String a,String b,String c) {
        List<String> recipients = new ArrayList<String>();
        recipients.add(a);
        //recipients.add("void.app@qq.com");
        String subject = b;
        String content = c;
        List<String> attachmentNames = new ArrayList<String>();
        //attachmentNames.add("C://Users//Administrator//Desktop//kali.txt");
        SendMailBySSL sendMailBySSL = new SendMailBySSL("smtp.126.com", "465",
                "email_test_2017@126.com", "et2me0", recipients, subject, content,
                attachmentNames);
